...
namespace Hl7.Fhir.WebApi
{
    ...
    public partial class FhirSTU3Controller : ApiController
    {
        ...
        [HttpGet, Route("{ResourceName}/{id}"), Authorize]
        public HttpResponseMessage Get(string ResourceName, string id)
        {
            try
            {
                var response = Get(ResourceName, id, null);
                return response;
            }
            catch (Exception ex)
            {
        ...
        [HttpGet, Route("{ResourceName}/{id}/_history/{vid}"), Authorize]
        ...
        [HttpGet, Route("{ResourceName}/{id}/${operation}"), Authorize]
        ...
        [HttpPost, Route("{ResourceName}/{id}/${operation}"), Authorize]
        ...
        [HttpGet, Route("{ResourceName}/${operation}"), Authorize]
        ...
        [HttpPost, Route("{ResourceName}/${operation}"), Authorize]
        ...
        [HttpPost, HttpGet, Route("${operation}"), Authorize]
        ...
        [HttpGet, Route("{ResourceName}/_search"), Authorize]
        ...
        [HttpGet, Route("{ResourceName}"), Authorize]
        ...
        [HttpPost, Route("{ResourceName}/_search"), Authorize]
        ...
        [HttpGet, Route("{ResourceName}/_history"), Authorize]
        ...
        //[HttpGet, Route("{type}/{id}/_history/{vid}")]
        [HttpGet, Route("{ResourceName}/{id}/_history"), Authorize]
        ...
        [HttpGet, Route("_history"), Authorize]
        ...
        /// </remarks>
        [HttpPost, Route("{ResourceName}", Order = 0), Authorize]
        ...
        /// <param name="bodyResource"></param>
        /// <returns></returns>
        [HttpPut, Route("{ResourceName}"), Authorize]
        ...
        // PUT fhir/Patient/5
        [HttpPut, Route("{ResourceName}/{id}"), Authorize]
        ...
        [HttpDelete, Route("{ResourceName}/{id}"), Authorize]
        ...
        [HttpDelete, Route("{ResourceName}"), Authorize]

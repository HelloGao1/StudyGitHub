...
{
    public class MedicationRequestService : BaseService, IFhirResourceServiceSTU3
    {
        ...
        public Bundle Search(IEnumerable<KeyValuePair<string, string>> parameters, int? Count, SummaryType summary)
        {
            ...
            Bundle medicationRequestBundle = MedicationRequestMapping.MapFromCDRToFHirModelBundle(uri);
